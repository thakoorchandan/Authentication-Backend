...
//--------- Registering the User ----------
 ...
 body("email").notEmpty().isEmail().withMessage("Email is required and should be a valid email"),
...
router.post("/signin", 
body("email").notEmpty().withMessage("Email should not be empty and should be valid email"),
body("password").notEmpty().withMessage("Password field cannot be empty")
,async(req,res)=>{
    try{
